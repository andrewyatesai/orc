...
export class LogicalClientConnectionPath {
  ...
  // Why: a scheduled Relay recovery surfaces the supervisor's failure streak so a
  // continuous outage can escalate; the physical count wins whenever it is larger.
