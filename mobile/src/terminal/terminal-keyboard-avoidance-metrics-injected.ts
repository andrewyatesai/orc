// In-WebView keyboard-avoidance metrics, injected into XTERM_HTML. Scans the
// visible viewport bottom-up for the last non-blank row so a main-buffer TUI
// footer below the caret still clears the raised input dock / iOS keyboard.
// Closes over term / notify defined in the host IIFE.
