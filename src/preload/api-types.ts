...
import type { OpenCodeUsageBreakdownKind, OpenCodeUsageSnapshot } from '../shared/opencode-usage-types'
import type {
  AiVaultListArgs,
  AiVaultListResult,
...
export type AiVaultApi = {
  ...
  /** Deletes a local single-file provider session; main re-validates the path. */
