...
export const __wasm_bindgen_func_elem_2092: (a: number, b: number, c: number, d: number) => void;
export const __wasm_bindgen_func_elem_2017: (a: number, b: number, c: number) => void;
