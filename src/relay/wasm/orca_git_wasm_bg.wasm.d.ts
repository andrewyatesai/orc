...
export const quickopenindex_rankIndices: (a: number, b: number, c: number, d: number, e: number) => void;
...
export const __wasm_bindgen_func_elem_2231: (a: number, b: number) => void;
export const __wasm_bindgen_func_elem_2320: (a: number, b: number, c: number, d: number) => void;
export const __wasm_bindgen_func_elem_2245: (a: number, b: number, c: number) => void;
