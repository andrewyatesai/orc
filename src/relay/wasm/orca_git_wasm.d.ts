...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_2006: (a: number, b: number) => void;
    readonly __wasm_bindgen_func_elem_2095: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_2020: (a: number, b: number, c: number) => void;
