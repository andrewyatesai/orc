...
export const STORY_WORLD_MANIFEST: AppModeManifest = {
  ...
  capsules: {
    ...
    // §7.1: the in-window escape. Without it the only routes out of Story World
    // are the menu bar — auto-hidden on Windows and Linux until Alt — and a
    // keyboard shortcut, which is no route at all for a six-year-old.
