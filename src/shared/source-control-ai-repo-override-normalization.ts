// Normalizing a repo's persisted `sourceControlAi` override blob: the untrusted
// JSON is filtered to the modelled shape, and legacy per-operation instructions
// are migrated forward into action command templates.
//
