...
describe('describeToolInput', () => {
  ...
  it('keeps the filename when trimming an overlong path', () => {
    ...
    const path = `/home/me/orca/workspaces/orca/sta-3333/src/shared/${'nested/'.repeat(4)}app.tsx`
  ...
  it('distinguishes two long paths that share a deep prefix', () => {
    const base = '/home/me/orca/workspaces/orca/sta-3333-tool-summary/src/session/native'
