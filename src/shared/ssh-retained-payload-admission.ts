...
export function admitSshConnectionState(
  ...
  // Why: providerEpoch and connectionGeneration are one authority; a half-present pair is a corrupt token, not a partial one.
  if (
...
/** Legacy/renderer path: an unpaired authority is normalized to unknown rather than rejected outright. */
