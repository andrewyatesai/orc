...
// Directory fsync is unsupported on some filesystems; treat those codes as a no-op.
...
// Why: crash-durable variant for records whose loss silently strands a committed
// cloud mutation (artifact share edit-tokens, create-recovery intents).
