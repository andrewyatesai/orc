...
// Why: tailnet classification is rust-sole (orca-core tailnet_address), and this shared module also
// runs in the renderer — so it goes through the seam and degrades to 'public' pre-wasm-ready.
function isTailnetIPv4Address(hostname: string): boolean {
  return (
    (tryOrcaDispatch('tailnet-address', 'isTailnetIPv4Address', hostname) as boolean | null) ??
    false
  )
}
