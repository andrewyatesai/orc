...
/** True only for the observed post-compaction continuation prompt, which fires a
 *  UserPromptSubmit with no matching Stop and would otherwise resurrect working. */
