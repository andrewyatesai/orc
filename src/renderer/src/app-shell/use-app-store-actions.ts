...
export function useAppStoreActions() {
  return useAppStore(
    useShallow((s) => ({
      ...
      fetchProjectGroupsForRuntimeEnvironment: s.fetchProjectGroupsForRuntimeEnvironment,
      fetchFolderWorkspaces: s.fetchFolderWorkspaces,
      fetchFolderWorkspacesForAllHosts: s.fetchFolderWorkspacesForAllHosts,
      fetchFolderWorkspacesForRuntimeEnvironment: s.fetchFolderWorkspacesForRuntimeEnvironment,
