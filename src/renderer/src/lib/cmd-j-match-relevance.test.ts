...
describe('getWorktreeMatchRelevance', () => {
  ...
  it('scores against worktree.displayName even when it is empty', () => {
    expect(
      getWorktreeMatchRelevance(
        makeMatch({
          matchedField: 'displayName',
...
describe('getOpenTabMatchRelevance', () => {
  ...
  it('scores the browser workspace label as ambient context', () => {
    ...
    const secondary = getOpenTabMatchRelevance(makeOpenTab({ secondaryRange: { start: 0, end: 4 } }))
