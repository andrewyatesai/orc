...
/**
 * Row model for Cmd+J's empty-query "Recent chats & terminals" section. Ranking is a two-tier
 * collapse of the sidebar's attention model, deliberately blind to agent activity (`updatedAt`)
 * so a chatty agent can't pin itself to the top.
 */
