import { branchName } from './git-utils'
...
// Why worktree.displayName/branchName and not a resolver: the search (worktree-palette-search)
// ranges displayNameRange into worktree.displayName and branchRange into branchName(worktree.branch),
// so relevance must score against the exact text those offsets index into.
export function getWorktreeMatchRelevance(
  ...
  return scorePaletteRelevance([
    ...
    {
      text: branchName(worktree.branch),
