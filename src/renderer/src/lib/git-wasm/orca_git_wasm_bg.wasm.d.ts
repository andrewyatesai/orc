...
export const __wasm_bindgen_func_elem_1949: (a: number, b: number, c: number, d: number) => void;
export const __wasm_bindgen_func_elem_1874: (a: number, b: number, c: number) => void;
