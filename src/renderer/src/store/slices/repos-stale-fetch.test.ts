...
// Why (#11611): a restored workspace keyed on the local repo — hydration keeps the tab (and its original
// ptyId, so the daemon PTY reattaches) only when the local catalog settled and the repo is present.
