...
// Why: the automatic reconnect chain is bounded per authority; authority rotation (a fresh
// connection incarnation) is the reset boundary, so a flapping relay cannot fan out unbounded remounts.
