// Fork: target scoping collects project-group subtrees through wasm, so init the
// real Rust path instead of asserting against the root-only pre-ready fallback.
