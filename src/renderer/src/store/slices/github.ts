    ...
    const request = (async () => {
      ...
      try {
        ...
        set((s) => {
          ...
          const sourcesUnchanged = areCatalogValuesEqual(previousEntry?.sources, envelope.sources)
          const errorUnchanged = areCatalogValuesEqual(previousEntry?.error, errorForCache)
