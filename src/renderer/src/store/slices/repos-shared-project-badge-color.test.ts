// Fork: badge-color normalization runs in the Rust core via wasm, so sanitizeRepoUpdate
// drops back to the default color until the renderer wasm is initialized.
