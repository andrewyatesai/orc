...
// Every PTY id a persisted terminal row lays claim to: its own, its remote session, and its layout leaves.
...
export type TerminalSlice = {
  ...
  createTab: (
    ...
    options?: {
      ...
      startupCwd?: string
      /** Why: ephemeral setup terminals opt out of the worktree's WSL distro so a host-native fallback command runs on the host shell. */
