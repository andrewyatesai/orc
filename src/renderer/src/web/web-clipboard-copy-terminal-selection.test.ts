...
/** Stands in for the terminal engine's copy handler: bubble-phase, overwrites text/plain. */
...
describe('web copy fallback vs. the terminal selection', () => {
  ...
  it('copies the requested text even when the selection anchor is inside a terminal', () => {
    ...
    // dispatches from there and a capture-phase write loses to the engine's bubble handler.
