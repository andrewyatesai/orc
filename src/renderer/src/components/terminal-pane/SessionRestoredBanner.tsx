...
export function SessionRestoredBanner({
  ...
  // Why: resume-unavailable started a fresh session, so there is no restored
  // command to re-run — only the plain marker applies.
  if (!lastCommand || reason === 'resume-unavailable') {
    return (
