 ...
 * Falls back to the worktree-path shape so existing WSL-filesystem worktrees are
 * unchanged; returns null when neither the runtime nor the path yields a distro.
 */
