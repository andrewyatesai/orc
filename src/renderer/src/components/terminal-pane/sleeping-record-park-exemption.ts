 ...
 *  these — but only these: passive-completed evidence never resumes in place
 *  (its `--resume` is owned by fresh-tab activation), so exempting it would pin
 *  a hidden pane mounted indefinitely for nothing. */
