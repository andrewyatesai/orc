import type { ForegroundTerminalOutputTarget } from '@/lib/pane-manager/pane-terminal-foreground-render-settle'
import { waitForTerminalOutputParsed } from '@/lib/pane-manager/pane-terminal-output-scheduler'

type InitialRenderPaneManager = {
  getPanes(): { terminal: ForegroundTerminalOutputTarget }[]
}
