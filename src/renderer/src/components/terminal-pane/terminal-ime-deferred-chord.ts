 ...
 * unowned deferral has no exit when compositionend never arrives: its listener outlives the pane
 * and a later composition flushes the stale chord against a rebound terminal (STA-4476).
 */
