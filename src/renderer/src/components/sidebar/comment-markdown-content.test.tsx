...
describe('CommentMarkdown', () => {
  ...
  it('renders trusted document markdown images inline with an expand control', () => {
    // Why: document bodies need a large preview without a provider-specific renderer.
    const markup = renderToStaticMarkup(
      <CommentMarkdown variant="document" content="Shot: ![ui.png](data:image/png;base64,abc123)" />
    )
