...
describe('showPreservedBranchBatchToast', () => {
  ...
  it('force-deletes only the branches selected in review', async () => {
    ...
    // Fork i18n renders English from the inline defaultValue, so count=1 keeps the plural wording.
    await clickButton(document.body, 'Force Delete 1 Branches')
  ...
  it('keeps older-server branches visible without offering an unsafe delete', () => {
    ...
    expect(toast.warning).toHaveBeenCalledWith(
      '3 workspaces removed, 1 branches kept',
