...
// Why: the menu snapshots a stable delete identity at click time, then defers the
// dispatch to the next macrotask so Radix finishes closing before the sidebar remounts.
