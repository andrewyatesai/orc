...
import type { AgentSelection } from '@/components/agent/AgentCombobox'
...
vi.mock('@/components/agent/AgentCombobox', () => ({
  default: ({ value }: { value: AgentSelection }) =>
    React.createElement('div', { 'data-agent': value.kind === 'builtin' ? value.agent : '' })
}))
