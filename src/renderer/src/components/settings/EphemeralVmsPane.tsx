...
export function EphemeralVmsPane(): React.JSX.Element {
  ...
  // sibling panes rely on to reach the Windows npx preflight.
  const installCommand = activeSkillRuntime.installDisabledReason
    ? EPHEMERAL_VMS_SKILL_INSTALL_COMMAND
    : buildSkillCommandForRuntime(EPHEMERAL_VMS_SKILL_INSTALL_COMMAND, activeSkillRuntime.agentRuntime)
  const updateCommand = activeSkillRuntime.installDisabledReason
    ? EPHEMERAL_VMS_SKILL_UPDATE_COMMAND
    : buildSkillCommandForRuntime(EPHEMERAL_VMS_SKILL_UPDATE_COMMAND, activeSkillRuntime.agentRuntime)
