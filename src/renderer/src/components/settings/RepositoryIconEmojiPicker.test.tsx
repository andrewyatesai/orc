...
// Boot the orca-git wasm so the component's real sanitizeRepoIcon (Rust-backed
// in this fork, from @/lib/git-wasm/repo-icon) runs instead of its pre-ready
// pass-through — the over-cap rejection below only holds with the real cap.
