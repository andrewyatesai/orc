...
describe('selectRefreshedNetworkAddress', () => {
  ...
  // Why: matches main's default — advertising nothing beats advertising docker0, and Relay pairs
  // without a direct address. A divergence here would show an address the QR never carried.
