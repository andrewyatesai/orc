...
// Radix anchors the tooltip to the row, so a cursor position has to be restated
// as offsets from the row's bottom-left corner to land under the pointer.
...
export function EntryActionRow({
  ...
  // its detail in full, and STYLEGUIDE.md rules out labelling those.
