...
// date shapes following the OS region is conventional. The language can change at runtime, so
// resolve through getIntlLocale() and cache per resolved locale rather than freezing one
// formatter (with the OS locale) at module scope.
