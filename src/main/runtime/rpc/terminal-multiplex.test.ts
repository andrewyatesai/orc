...
describe('terminal multiplex RPC', () => {
  ...
  it('multiplexes terminal streams and routes desktop resize to the source PTY', async () => {
    ...
    try {
      ...
      // The requested snapshot takes the AUTHORITATIVE buffer and serializes the
      // VISIBLE grid only (scrollbackRows:0); history is supplied once via
      // scrollbackAnsi, never prepended into data.
