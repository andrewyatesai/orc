...
describe('runtime RPC startup failure reporting', () => {
  ...
  it.each([
    ...
    const error = Object.assign(new Error('/home/private/orca-runtime.json'), { code })
  ...
  it('records a privacy-safe telemetry event', () => {
    ...
    const error = Object.assign(new Error('/home/private/orca-runtime.json'), { code: 'EACCES' })
    ...
    expect(JSON.stringify(trackMock.mock.calls)).not.toContain('/home/private')
