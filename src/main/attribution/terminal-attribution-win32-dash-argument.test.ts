...
// Why: `powershell.exe -File <script> ... -` fails argument binding with
// PSArgumentException before the script runs, so any command carrying a bare
// `-` must never be dispatched to the PowerShell wrapper.
