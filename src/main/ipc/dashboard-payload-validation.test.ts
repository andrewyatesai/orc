...
// Why: the sanitizer is the Rust core reached over napi, so wrap that seam, not the shared types.
import type * as RepoIconModule from '../rust-repo-icon'
...
vi.mock('../rust-repo-icon', async (importOriginal) => {
