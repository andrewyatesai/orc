...
// Fork: filesystem-watcher.ts debounces delivery with a 150ms trailing window
// (DEBOUNCE_TRAILING_MS), not the upstream shared filesystem-watch-batch-window.
const WATCH_BATCH_TRAILING_MS = 150
