...
// gathers base refs and checks tree-equal merge / patch-equivalence / squash match,
// refreshing remotes (non-fatal fetch) only when local refs are inconclusive;
// `runGit` still executes git (SSH/WSL-safe),
