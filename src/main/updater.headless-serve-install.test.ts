...
vi.mock('./updater-prerelease-feed', () => ({
  ...
  // fork-only: updater.ts's manual release check normalizes feed tags
...
// Fork-only: quitAndInstall scans for other running instances and publishes a relaunch-race marker.
