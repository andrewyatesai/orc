...
type ScanHandle = {
  ...
  // Why: the in-flight ports.detect for this target. Aborting it on stop/replace
  // sends rpc.cancel so the relay drops its /proc walk instead of finishing an
  // abandoned scan the client will discard.
