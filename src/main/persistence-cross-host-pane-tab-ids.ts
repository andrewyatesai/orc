 ...
 * migrated last — routing one host's pane at another host's terminal. Skip aliasing them instead.
 */
...
/** Drop the given tab ids from a per-tab acknowledgement remap so colliding tabs are never rerouted. */
