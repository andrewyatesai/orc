...
vi.mock('./browser-session-registry', () => ({
  browserSessionRegistry: {
    ...
    getCookieStagingDir: getCookieStagingDirMock,
...
describe('importCookiesFromBrowser Chromium', () => {
  ...
  beforeEach(() => {
    ...
    getCookieStagingDirMock.mockReset()
    getCookieStagingDirMock.mockImplementation(() => activeStagingDir(join(tmpDir, 'userData')))
