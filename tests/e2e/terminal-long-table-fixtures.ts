...
// Assembled, not written out, so `did:key:<long id>` does not read as a credential
// to the public-snapshot secret scan. Value unchanged.
const NARROW_SIGNER_DID = `did:key:${'z6Mkuw5kQqz1QvZ9f3d2aB7f19f0cAC7B4F3c9E725'}aD19cD12e6A8B3F4c5D6e7F8a9B0c1D2e3F4a5B6c7D8e9F0a1B2c3D4e5F6a7B8c9D0e1F2`
