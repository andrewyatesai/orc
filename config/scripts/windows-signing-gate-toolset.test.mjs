...
const HAS_CI_SIGNING_WORKFLOWS = GATED_WORKFLOWS.every((name) =>
  existsSync(join(workflowsDir, name))
)
...
describe.skipIf(!HAS_CI_SIGNING_WORKFLOWS)(
  'Windows signing gates resolve 7za through the toolset resolver (#6487)',
  () => {
